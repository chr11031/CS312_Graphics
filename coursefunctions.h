...
void TestDrawFragments(Buffer2D<PIXEL> & target)
{
        ...
        ****************************************************/
        ...
        // new image
        static BufferImage myImage("C:\\Users\\Grayson\\Documents\\CSGraphics\\CS312_Graphics\\checker.bmp");
...
void TestDrawPerspectiveCorrect(Buffer2D<PIXEL> & target)
{
        ...
        **************************************************/
        ...
        // sets up x,y,z, and w values for each vertex
        ...
        // Image of red and white checkerboard 
        BufferImage myImage("checker.bmp");

        // Sets uniforms to image
        Attributes imageUniforms;
        imageUniforms.ptrImg = &myImage;

        // Sets fragment shader to image fragment shader
...
void TestVertexShader(Buffer2D<PIXEL> & target)
{
        ...
        *************************************************/
        ...
        myColorVertexShader.VertShader = CustomVertShader;
        ...
        colorUniforms.matrix.translation(100, 50, 0);
	...
	DrawPrimitive(TRIANGLE, target, colorTriangle, colorAttributes, &colorUniforms, &myColorFragShader, &myColorVertexShader);
        ...
        colorUniforms.matrix.scaling(0.5);
        ...
        colorUniforms.matrix.rotation(45);
	...
	colorUniforms.matrix.combined(45, 100, 50, 0, 0.5);
