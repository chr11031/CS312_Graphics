...
void TestDrawFragments(Buffer2D<PIXEL> & target)
{
        ...
        *************************************************/
        // set vertices of the color triangle
        ...
        // first vertex is red, second green, third blue
        ...
        // assign the anonymous fragment shader to the color shader
        FragmentShader myColorFragShader = ColorFragShader;

        Attributes colorUniforms;
        // nothing needs to be set up this time
        ...
        ****************************************************/
        ...
        // set triangle vertices for the image triangle
...
void TestVertexShader(Buffer2D<PIXEL> & target)
{
        ...
        *************************************************/
        ...
        colorAttributes[0].addAttributes(1,0,0);
        colorAttributes[1].addAttributes(0,1,0);
        colorAttributes[2].addAttributes(0,0,1);    
        ...
        myColorVertexShader = VertexShader(&TransformationVertShader);
        ...
        colorUniforms.addAttributes(100, 50);
	DrawPrimitive(TRIANGLE, target, colorTriangle, colorAttributes, &colorUniforms, &myColorFragShader, &myColorVertexShader);
        ...
        colorUniforms.addAttributes(0,0,0,0,0.5,0.5,0);
        DrawPrimitive(TRIANGLE, target, colorTriangle, colorAttributes, &colorUniforms, &myColorFragShader, &myColorVertexShader);
        ...
        colorUniforms.addAttributes(0,0,0,0.523599/* 30 degrees in radians*/,0,0,0);
        DrawPrimitive(TRIANGLE, target, colorTriangle, colorAttributes, &colorUniforms, &myColorFragShader, &myColorVertexShader);
	...
	// Your scale-translate-rotation code that integrates with 'colorUniforms', used by 'myColorVertexShader' goes here
        colorUniforms.addAttributes(100,50,0,0.523599/* 30 degrees in radians*/,0.5,0.5,1);
        DrawPrimitive(TRIANGLE, target, colorTriangle, colorAttributes, &colorUniforms, &myColorFragShader, &myColorVertexShader);	
