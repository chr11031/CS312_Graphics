...
Transform orthgraphic(const double & RIGHT, const double & LEFT, const double & TOP, const double & BOTTOM, const double & NEAR, const double &FAR)
{
    Transform rto;
		
		
		rto[0][0] = 2/(RIGHT-LEFT);
		rto[0][2] = 0;
		rto[0][1] = 0;
		rto[0][3] = -(RIGHT+LEFT)/(RIGHT-LEFT);
		
		rto[1][0] = 0;
		rto[1][1] = 2/(TOP-BOTTOM);
		rto[1][2] = 0;
		rto[1][3] = -(TOP+BOTTOM)/(TOP-BOTTOM);

		rto[2][0] = 0;
		rto[2][1] = 0;
		rto[2][2] = 2/(FAR-NEAR);
		rto[2][3] = (LEFT+NEAR)/(FAR-NEAR);
